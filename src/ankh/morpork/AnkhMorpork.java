...
public class AnkhMorpork {
    ...
    int i=0;
    public boolean shuffleCards(int no_of_players){
        if(no_of_players>=2 && no_of_players<5)
        {
	...
	public static void deck(Collection<String> green, Collection<String> brown){
        ...
        public boolean next_turn(int i){
            if(i>=0 && i<=3)
            {
            boolean[] turn = null;        
         ...
         */
        public boolean distribute(String[] players){
         ...
         */
        public boolean turn(int no_of_players){
         if(no_of_players>=2 && no_of_players<5)
         {
